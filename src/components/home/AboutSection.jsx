...
// const features = [
//   { label: "Charity For Foods", color: "bg-[#1a7a5e]" },
//   { label: "Charity For Water", color: "bg-yellow-400" },
//   { label: "Charity For Education", color: "bg-orange-500" },
//   { label: "Charity For Medical", color: "bg-gray-800" },
// ];
